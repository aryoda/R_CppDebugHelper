...
|------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| R for Windows                                                                | Windows binaries for the R base distribution                                                                                                                                                  |
| Rtools                                                                       | Contains the `gdb` debugger and C/C++ compiler (required to compile the C/C++ code with debugging symbols)                                                                                    |
| (R source code)                                                              | Optional: If you want to debug R itself or set breakpoints into R functions by name you have to recompile R on Windows (not recommended - takes a lot of time for setup and solving problems) |
...
- All `g++` command must contain the `-g -O2` switch (and no other `-g*` or `-O*` switches after (right from)
...
# TODO Options and step-by-step instructions...
