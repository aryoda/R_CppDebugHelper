...
RGui     gdb RGui.exe   no Ctrl + C (but menu item)   separate output for R and gdb
RScript  gdb RScript    no Ctrl + c (but CC works)    same output terminal for R and gdb
R        gdb --pid=123  Ctrl + c works (CC too)       separate output for R and gdb
